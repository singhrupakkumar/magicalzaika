...
jQuery(document).ready(function($) {
    ...
    if (!($.cookie('tp_stylesheet'))) {
        ...
        if (link.length>0) {
            link.attr('href','http://localhost/2018/restaurant/assets/css/color/' + tp_stylesheet + '.css');
            $('.style-customizer .styleChange li[data-style="'+tp_stylesheet+'"]').addClass("selected");			 	
        };
    };	
    ...
    if ($("body").hasClass("header-0")){
        document.getElementById("logo_img").src="http://localhost/2018/restaurant/assets/images/logo/logo.png";
    } else {
        //document.getElementById("logo_img").src="http://localhost/2018/restaurant/assets/images/logo/logo-white.png";
    }
