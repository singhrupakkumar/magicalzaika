...
class StaticpagesController extends AppController
{
	...
	public function beforeFilter(Event $event) {
        ...
        $this->Auth->allow(['view','faq','contact','term','promoteproduct','aboutus','privacy']);      
        $this->authcontent();    
    }
    ...
    if($this->request->is('post')){    
       if(!empty($this->request->data['email'])){        
                ...
                $email->from(['rupak.webcreaters@gmail.com' => 'Magical Zaika'])
                        ->emailFormat('html')
                        ->template('default', 'default')
                        ->to('rupak.webcreaters@gmail.com')
