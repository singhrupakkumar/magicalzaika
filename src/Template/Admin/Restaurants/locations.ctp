<section class="content-header">
    <h1> 
    <?= __('Restaurent Locations') ?>   <?= $this->Html->link(__('Add Location'), ['action' => 'locationadd/'.$rest_id], ['class' => 'btn btn-warning']) ?>
    <small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="dashboard"><i class="fa fa-dashboard"></i> Home</a></li> 
        <li class="active"><?= __('Restaurent Locatios') ?></li>
    </ol>
</section>
	...
	<div class="row">
        ...
        <div class="box">
            ...
            <tr>
                ...
                <tbody>
                <?php foreach ($restaurentlocations as $store): ?>
            <tr>
