<section class="content-header">
   ...
   <?= __('Sub categories') ?>
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><?= __('Add Sub categories') ?></li>
    </ol>
</section>
	...
	<div class="row">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><?= __('Add Sub categories') ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <?= $this->Form->create($subcategories, ['id' => 'subcategories-form', 'enctype' => 'multipart/form-data']) ?>
              <div class="box-body">
                <div class="form-group">
                  <div class="form-group">     
                 <?php
                  echo $this->Form->control('category_id', ['options' => $parentCategories, 'empty' => true,'class' => 'form-control']);  
                 ?>    
                 </div>     
                <div class="form-group">
