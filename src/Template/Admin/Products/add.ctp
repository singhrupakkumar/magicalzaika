            ...
            <?= $this->Form->create($product, ['id' => 'product-form', 'enctype' => 'multipart/form-data']) ?>
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <?php echo $this->Form->control('rest_id',['class' => 'form-control','label'=>'Restaurant']);?> 
                  <?php echo $this->Form->control('cat_id',['class' => 'form-control','label'=>'Category']);?>

                  <?php// echo $this->Form->control('subcat_id',['class' => 'form-control','label'=>'Sub Category']);?>
              
                  <?php echo $this->Form->control('price',['class' => 'form-control','min'=>1]);?> 
                  <?php echo $this->Form->control('price_two',['class' => 'form-control','min'=>1]);?> 
                   <?php echo $this->Form->control('quantity',['class' => 'form-control','required']);?>
