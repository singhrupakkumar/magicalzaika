...
class PayRequest  
  extends PPMessage   {
	 ...
	 */
	public function __construct($requestEnvelope = NULL, $actionType = NULL, $cancelUrl = NULL, $currencyCode = NULL, $receiverList = NULL, $returnUrl = NULL, $ipnNotificationUrl = NULL) {
